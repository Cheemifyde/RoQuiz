...
export declare let DiagnosticMessages: {
     ...
     */
    globalCallableRemoved: (name?: string, axis?: AvailabilityAxis, threshold?: string, current?: string) => {
        message: string;
        code: number;
        data: {
            name: string;
     ...
     * be migrated.
     */
    globalCallableDeprecated: (name?: string, axis?: AvailabilityAxis, threshold?: string, current?: string) => {
        message: string;
        code: number;
        data: {
            name: string;
