...
class NamespacedVariableNameExpression extends AstNode_1.Expression {
    ...
    getTypedef(state) {
        return [
            state.sourceNode(this, this.getName(Parser_1.ParseMode.BrighterScript))
        ];
    }
    getNameParts() {
        let parts = [];
...
class AAIndexedMemberExpression extends AstNode_1.Expression {
    constructor(options) {
        ...
        this.range = util_1.default.createBoundingRange(this.tokens.leftBracket, this.key, this.tokens.rightBracket, this.tokens.colon, this.value);
    }
    transpile(state) {
        return [];
    }
    ...
    transpile(state) {
        ...
        for (let i = 0; i < this.elements.length; i++) {
            ...
            if ((0, reflection_1.isCommentStatement)(element)) {
                ...
                //colon
                result.push(state.transpileToken('tokens' in element ? element.tokens.colon : element.colonToken), ' ');
                //value
...
function expressionToValue(expr, strict) {
    ...
    if ((0, reflection_1.isAALiteralExpression)(expr)) {
        return expr.elements.reduce((acc, e) => {
            if (!(0, reflection_1.isCommentStatement)(e) && !((0, reflection_1.isAAIndexedMemberExpression)(e))) {
