...
class BrsFilePreTranspileProcessor {
    ...
    processExpression(ternaryExpression, scope) {
        ...
        this.processExpressionInNamespace(ternaryExpression, scope, containingNamespace, new Set());
    }
    processExpressionInNamespace(expression, scope, containingNamespace, visitedConsts) {
        var _a, _b, _c;
        ...
        for (let part of parts) {
            let entityName;
            if ((0, reflection_1.isVariableExpression)(part) || (0, reflection_1.isDottedGetExpression)(part)) {
                processedNames.push((_b = (_a = part === null || part === void 0 ? void 0 : part.name) === null || _a === void 0 ? void 0 : _a.text) === null || _b === void 0 ? void 0 : _b.toLocaleLowerCase());
            ...
            let constStatement = (_c = scope === null || scope === void 0 ? void 0 : scope.getConstFileLink(entityName, containingNamespace)) === null || _c === void 0 ? void 0 : _c.item;
            if (constStatement) {
            ...
            if (value && !isCircular) {
                ...
                if (constStatement && !(0, reflection_1.isLiteralExpression)(value)) {
    ...
    processInlinedConstValue(value, scope, constStatement, visitedConsts) {
        var _a;
