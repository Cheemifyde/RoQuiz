...
exports.parseMilliseconds = exports.formatLogTimestamp = exports.formatTimestampForScreenshot = exports.formatTimestampForPackage = void 0;
 ...
 */
function formatTimestampForPackage(date = new Date()) {
    return [
...
exports.formatTimestampForPackage = formatTimestampForPackage;
/**
 * Format a date as `YYYY-MM-DD-HH.mm.ss.SSS` (e.g. `2026-06-29-14.30.45.123`).
 * Reproduces `dayjs(date).format('YYYY-MM-DD-HH.mm.ss.SSS')`.
 */
function formatTimestampForScreenshot(date = new Date()) {
    return `${date.getFullYear()}-${pad(date.getMonth() + 1)}-${pad(date.getDate())}-` +
        `${pad(date.getHours())}.${pad(date.getMinutes())}.${pad(date.getSeconds())}.${pad(date.getMilliseconds(), 3)}`;
}
exports.formatTimestampForScreenshot = formatTimestampForScreenshot;
/**
