...
class ProgramBuilder {
    ...
    printDiagnostics(diagnostics) {
        ...
        const reporters = diagnosticUtils.normalizeDiagnosticReporters((_b = this.options) === null || _b === void 0 ? void 0 : _b.diagnosticReporters, this.logger)
        ...
        for (let srcPath of srcPaths) {
            ...
            //load the file text
            const file = (_c = this.program) === null || _c === void 0 ? void 0 : _c.getFile(srcPath);
            //get the file's in-memory contents if available
            const lines = (_e = (_d = file === null || file === void 0 ? void 0 : file.fileContents) === null || _d === void 0 ? void 0 : _d.split(/\r?\n/g)) !== null && _e !== void 0 ? _e : [];
            for (let diagnostic of sortedDiagnostics) {
                ...
                let relatedInformation = ((_f = diagnostic.relatedInformation) !== null && _f !== void 0 ? _f : []).map(x => {
