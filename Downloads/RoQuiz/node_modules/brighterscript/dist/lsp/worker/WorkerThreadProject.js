...
class WorkerThreadProject {
    ...
    async getFileRenameEdits(options) {
        return this.sendStandardRequest('getFileRenameEdits', options);
    }
    ...
    async getSourceFixAllCodeActions(options) {
        return this.sendStandardRequest('getSourceFixAllCodeActions', options);
    }
    async getSelectionRanges(options) {
        return this.sendStandardRequest('getSelectionRanges', options);
    }
    async getInlayHints(options) {
        return this.sendStandardRequest('getInlayHints', options);
    }
