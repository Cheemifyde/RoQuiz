...
exports.ScopeNamespaceLookup = void 0;
 ...
 */
class ScopeNamespaceLookup extends Map {
    constructor(scope) {
        super();
        this.scope = scope;
    ...
    has(key) {
        const lower = key === null || key === void 0 ? void 0 : key.toLowerCase();
        if (!lower) {
            return false;
        }
        if (super.has(lower)) {
     ...
     */
    wrapSingleContribution(contribution, nameLower) {
     ...
     */
    aggregateContributions(contributions, nameLower) {
        // eslint-disable-next-line @typescript-eslint/dot-notation
     ...
     */
    buildScopedChildren(parentNameLower) {
...
exports.ScopeNamespaceLookup = ScopeNamespaceLookup;
//# sourceMappingURL=ScopeNamespaceLookup.js.map