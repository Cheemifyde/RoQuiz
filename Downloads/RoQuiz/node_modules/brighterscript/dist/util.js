...
class Util {
    ...
    diagnosticIsSuppressed(diagnostic) {
        ...
        if (diagnosticCode === DiagnosticMessages_1.DiagnosticCodeMap.unknownDiagnosticCode) {
            return false;
        }
        for (let flag of (_b = (_a = diagnostic.file) === null || _a === void 0 ? void 0 : _a.commentFlags) !== null && _b !== void 0 ? _b : []) {
            ...
            const isEnabled = flag.enableCodes === null || (diagnosticCode !== undefined && ((_c = flag.enableCodes) === null || _c === void 0 ? void 0 : _c.includes(diagnosticCode)));
            if (isEnabled) {
                continue;
            }
            //if this flag disables the code, it's suppressed
            const isDisabled = flag.codes === null || (diagnosticCode !== undefined && ((_d = flag.codes) === null || _d === void 0 ? void 0 : _d.includes(diagnosticCode)));
            if (isDisabled) {
                return true;
            }
        }
