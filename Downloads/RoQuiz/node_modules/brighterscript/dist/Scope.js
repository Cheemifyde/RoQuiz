    ...
    unlinkSymbolTable() {
        ...
        for (let file of this.getOwnFiles()) {
            if ((0, reflection_1.isBrsFile)(file)) {
                ...
                for (const namespace of file.parser.references.namespaceStatements) {
                    const namespaceNameLower = namespace.getName(Parser_1.ParseMode.BrighterScript).toLowerCase();
                    const aggregate = (_b = this.namespaceLookup.get(namespaceNameLower)) === null || _b === void 0 ? void 0 : _b.symbolTable;
                    if (aggregate) {
        ...
        for (let func of file.parser.references.functionExpressions) {
            ...
            const getNamespaceName = () => {
                ...
                if (!namespaceFetched) {
                    ...
                    currentNamespaceName = (_a = func.findAncestor(reflection_1.isNamespaceStatement)) === null || _a === void 0 ? void 0 : _a.getName(Parser_1.ParseMode.BrighterScript);
                }
        ...
        for (let scriptImport of scriptImports) {
            ...
            if (!referencedFile) {
                ...
                const correctUri = scriptImport.text.startsWith('pkg:/')
                    ? util_1.util.getRokuPkgPath(referencedFile.pkgPath)
                    : path.posix.relative(path.dirname(scriptImport.sourceFile.pkgPath).replace(/\\/g, '/'), referencedFile.pkgPath.replace(/\\/g, '/'));
                this.diagnostics.push(Object.assign(Object.assign({}, DiagnosticMessages_1.DiagnosticMessages.scriptImportCaseMismatch(referencedFile.pkgPath, correctUri)), { range: scriptImport.filePathRange, file: scriptImport.sourceFile }));
            }
        }
    }
    /**
