...
class BrsFile {
    ...
    getNamespaceContributions() {
        ...
        this.ast.walk((0, visitors_1.createVisitor)({
            NamespaceStatement: namespaceStatement => {
                ...
                const name = namespaceStatement.getName(Parser_1.ParseMode.BrighterScript);
                ...
                if (namespaceStatement.body.statements.length > 0) {
                    ((_a = ns.statements) !== null && _a !== void 0 ? _a : (ns.statements = [])).push(...namespaceStatement.body.statements);
                }
                for (const statement of namespaceStatement.body.statements) {
                    if ((0, reflection_1.isClassStatement)(statement) && statement.name) {
                        ((_b = ns.classStatements) !== null && _b !== void 0 ? _b : (ns.classStatements = {}))[statement.name.text.toLowerCase()] = statement;
                    }
                    else if ((0, reflection_1.isFunctionStatement)(statement) && statement.name) {
                        ((_c = ns.functionStatements) !== null && _c !== void 0 ? _c : (ns.functionStatements = {}))[statement.name.text.toLowerCase()] = statement;
                    }
                    else if ((0, reflection_1.isEnumStatement)(statement) && statement.fullName) {
                        ((_d = ns.enumStatements) !== null && _d !== void 0 ? _d : (ns.enumStatements = new Map())).set(statement.fullName.toLowerCase(), statement);
                    }
                    else if ((0, reflection_1.isConstStatement)(statement) && statement.fullName) {
                        ((_e = ns.constStatements) !== null && _e !== void 0 ? _e : (ns.constStatements = new Map())).set(statement.fullName.toLowerCase(), statement);
                    }
                }
                ...
                //was dead code)
                (_f = ns.symbolTable) !== null && _f !== void 0 ? _f : (ns.symbolTable = new SymbolTable_1.SymbolTable(`Namespace File Contribution: '${ns.fullName}' in ${this.pkgPath}`));
    ...
    get ownScriptImports() {
        var _a, _b;
        const result = (_b = (_a = this.cache) === null || _a === void 0 ? void 0 : _a.getOrAdd('ownScriptImports', () => {
            var _a, _b, _c, _d;
            const result = [];
    ...
    parse(fileContents) {
        try {
            ...
            this.diagnostics.push(Object.assign({ file: this, range: util_1.util.createRange(0, 0, 0, Number.MAX_VALUE) }, DiagnosticMessages_1.DiagnosticMessages.genericParserMessage('Critical error parsing file: ' + JSON.stringify(util_1.util.serializeError(e)))));
        }
    }
    /**
    ...
    getCommentFlags(tokens) {
        const processor = new CommentFlagProcessor_1.CommentFlagProcessor(this, ['rem', `'`], DiagnosticMessages_1.diagnosticCodes);
        this.commentFlags = [];
        ...
        for (let [, namespace] of scope.namespaceLookup) {
            ...
            if (namespace.fullName.toLowerCase() === closestParentNamespaceName) {
                ...
                for (let [, ns] of namespace.namespaces) {
                    if (!newToken || ((_a = ns.statements) === null || _a === void 0 ? void 0 : _a.find((s) => (0, reflection_1.isClassStatement)(s)))) {
                ...
                for (let stmt of (_b = namespace.statements) !== null && _b !== void 0 ? _b : []) {
    ...
    calleeIsKnownNamespaceFunction(callee, namespaceName) {
        ...
        if ((0, reflection_1.isVariableExpression)(callee) && namespaceName) {
            ...
            if (lowerCalleeName) {
                ...
                if ((_c = namespace === null || namespace === void 0 ? void 0 : namespace.functionStatements) === null || _c === void 0 ? void 0 : _c[lowerCalleeName]) {
                    return true;
                }
            }
        }
