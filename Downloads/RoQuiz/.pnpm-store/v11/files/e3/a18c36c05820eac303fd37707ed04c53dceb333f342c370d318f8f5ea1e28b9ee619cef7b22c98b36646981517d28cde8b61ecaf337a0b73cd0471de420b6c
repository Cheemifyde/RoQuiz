...
function isAAIndexedMemberExpression(element) {
    return (element === null || element === void 0 ? void 0 : element.constructor.name) === 'AAIndexedMemberExpression';
}
exports.isAAIndexedMemberExpression = isAAIndexedMemberExpression;
